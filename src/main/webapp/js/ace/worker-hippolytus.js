...
try {
    ...
    hippolytus = require('hippolytus/index');
} finally {
    require = ace_require;
}
...
var validate = function(input) {
    ...
    var lexer = new hippolytus.HippolytusLexer(stream);
    var tokens = new antlr4.CommonTokenStream(lexer);
    var parser = new hippolytus.HippolytusParser(tokens);
    var annotations = [];
...
ace.define("ace/mode/hippolytus_worker",["require","exports","module","ace/lib/oop","ace/worker/mirror"], function(require, exports, module) {
    "use strict";
