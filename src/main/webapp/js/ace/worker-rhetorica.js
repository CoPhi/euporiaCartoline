...
try {
    ...
    rhetorica = require('rhetorica/index');
} finally {
    require = ace_require;
}
...
var validate = function(input) {
    ...
    var lexer = new rhetorica.RhetoricaLexer(stream);
    var tokens = new antlr4.CommonTokenStream(lexer);
    var parser = new rhetorica.RhetoricaParser(tokens);
    var annotations = [];
...
ace.define("ace/mode/rhetorica_worker",["require","exports","module","ace/lib/oop","ace/worker/mirror"], function(require, exports, module) {
    "use strict";
